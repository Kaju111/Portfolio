          ...
          <div className="flex flex-col justify-center fixed top-0 left-0 w-full h-screen bg-amber-700 text-black">
            <motion.ul {...linkOptions}>
              <div className="grid grid-cols-3">
                <span
                  className="text-white font-name text-[50px] h-[100px] flex flex-col w-[25%] m-auto "
                  onClick={() => setNav(!nav)}
                >
                  <Link
                    className="hover:ml-[40px] hover:rounded-md duration-300"
                    to={"/"}
                  >
                    Intro
                  </Link>
