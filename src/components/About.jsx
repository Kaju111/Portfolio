...
const About = () => {
  return (
    <div id="about">
      <div
        className="text-white sm:h-[500px] h-[600px] dm:h-[500px] flex flex-col"
        id="about"
      >
        ...
        <span className="font-primary text-[15px] sm:text-[17px] md:text-[20px] mt-[40px] mb-[30px] sm:leading-[21px] leading-[17px] md:leading-[25px]">
